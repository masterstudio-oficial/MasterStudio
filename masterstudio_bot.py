import os # ¡Importante! Necesario para leer variables de entorno (Tokens)
import json
import base64
...
# =================================================================
# 🛑 CONFIGURACIÓN CRÍTICA (LEYENDO DESDE os.environ.get()) 🛑
# =================================================================
# Los valores se leen de las variables de entorno de la plataforma (PythonAnywhere, Heroku, etc.)
...
try:
    # PythonAnywhere/Heroku guarda el ID como string, lo convertimos a int para Discord
    GUILD_ID = int(os.environ.get("GUILD_ID"))
except (TypeError, ValueError):
    # Si la variable no existe o es inválida, usamos None
    GUILD_ID = None
...
async def on_ready():
    ...
    if GUILD_ID:
        try:
            ...
            # 1. Limpieza y sincronización de comandos
        ...
        print("Advertencia: GUILD_ID no configurado. Los comandos de barra pueden no funcionar.")
